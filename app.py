...
INDEX_HTML = '''
<!DOCTYPE html>
<html><head><title>روبیکا</title></head><body><h1>سلام</h1></body></html>
'''

USER_LOGIN_HTML = '''
<!DOCTYPE html>
<html><head><title>ورود</title></head><body><h1>ورود</h1></body></html>
'''

USER_DASHBOARD_HTML = '''
<!DOCTYPE html>
<html><head><title>داشبورد</title></head><body><h1>داشبورد</h1></body></html>
'''

ADMIN_LOGIN_HTML = '''
<!DOCTYPE html>
<html><head><title>ورود ادمین</title></head><body><h1>ورود ادمین</h1></body></html>
'''

ADMIN_DASHBOARD_HTML = '''
<!DOCTYPE html>
<html><head><title>پنل ادمین</title></head><body><h1>پنل ادمین</h1></body></html>
'''

ADMIN_BOT_SETTINGS_HTML = '''
<!DOCTYPE html>
<html><head><title>تنظیمات ربات</title></head><body><h1>تنظیمات ربات</h1></body></html>
'''

ERROR_HTML = '''
<!DOCTYPE html>
<html><head><title>خطا</title></head><body><h1>خطا</h1></body></html>
'''
...
def user_dashboard(token):
    ...
    return render_template_string(USER_DASHBOARD_HTML,
                                  user=user, status=status, used_gb=used_gb,
                                  limit_gb=limit_gb, percent=percent, domain=get_domain())
...
def admin_dashboard():
    ...
    return render_template_string(ADMIN_DASHBOARD_HTML,
                                  users=users, total=total, active=active, domain=get_domain())
...
def admin_bot_settings():
    ...
    if request.method == 'POST':
        ...
        return render_template_string(ADMIN_BOT_SETTINGS_HTML,
                                      ...
                                      bot_token=bot_token, admin_id=admin_id, is_active=is_active)
